...
if __name__ == "__main__":
    ...
    # for HE tum slides
    # python run_batch_of_slides.py --task seg --wsi_dir /mnt/oskar/he_tum_slides --job_dir /mnt/oskar/hest --gpu 0 --mag 40 --patch_size 512 --segmenter hest
    # python run_batch_of_slides.py --task coords --wsi_dir /mnt/oskar/he_tum_slides --job_dir /mnt/oskar/hest --gpu 0 --mag 40 --patch_size 512 --export_entropy_format
    # python run_batch_of_slides.py --task coords --wsi_dir /mnt/oskar/he_tum_slides --job_dir /mnt/oskar/hest --gpu 0 --mag 40 --patch_size 1024 --export_entropy_format
    # python run_batch_of_slides.py --task coords --wsi_dir /mnt/oskar/he_tum_slides --job_dir /mnt/oskar/hest --gpu 0 --mag 10 --patch_size 512 --export_entropy_format
    # python run_batch_of_slides.py --task coords --wsi_dir /mnt/oskar/he_tum_slides --job_dir /mnt/oskar/hest --gpu 0 --mag 10 --patch_size 1024 --export_entropy_format

    # for new slides
    # python run_batch_of_slides.py --task seg --wsi_dir /mnt/new_slides --job_dir /mnt/oskar/hest --gpu 0 --mag 40 --patch_size 512 --segmenter hest
    # python run_batch_of_slides.py --task coords --wsi_dir /mnt/new_slides --job_dir /mnt/oskar/hest --gpu 0 --mag 40 --patch_size 512 --export_entropy_format
